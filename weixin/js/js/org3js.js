...
//推荐人
        ...
        if (LicensePicId.length == 0 || OrgPromisePicIds.length == 0 || ReferrerPromisePicIds.length == 0  || StorefrontPicIds.length == 0 || PlacePicIds.length == 0 || ProductPicIds.length == 0) {
